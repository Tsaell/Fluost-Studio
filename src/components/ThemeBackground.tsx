...
export const ThemeBackground: React.FC<ThemeBackgroundProps> = ({ currentTheme }) => {
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden z-0 select-none hardware-accelerated">
      ...
      {/* SKY THEME: Continuous Ultra-Cloudy Floating Canvas, Sunbeams & Floating Shimmer */}
      {currentTheme === 'sky' && (
        <div className="absolute inset-0 overflow-hidden bg-gradient-to-b from-[#38BDF8] via-[#7DD3FC] to-[#BAE6FD]">
          ...
          >
            <div className="w-80 h-28 bg-white/90 rounded-full blur-[1px]" />
            <div className="w-[28rem] h-36 bg-sky-50/80 rounded-full blur-[1px]" />
            <div className="w-72 h-24 bg-white/85 rounded-full blur-[1px]" />
          </motion.div>
          ...
          >
            <div className="w-[34rem] h-44 bg-white/85 rounded-full blur-[1px]" />
            <div className="w-96 h-32 bg-sky-100/90 rounded-full blur-[1px]" />
            <div className="w-[30rem] h-40 bg-white/80 rounded-full blur-[1px]" />
          </motion.div>
          ...
          >
            <div className="w-[36rem] h-48 bg-white/95 rounded-full blur-[2px]" />
            <div className="w-[28rem] h-36 bg-sky-50/90 rounded-full blur-[2px]" />
          </motion.div>

          {/* Floating Birds Silhouettes */}
          {[1, 2].map((bird) => (
            <motion.div
              key={`bird-${bird}`}
              animate={{
                x: ['-10%', '110%'],
                y: [0, bird % 2 === 0 ? 15 : -15, 0],
              }}
              transition={{
                duration: 22 + bird * 6,
                repeat: Infinity,
              ...
              className="absolute opacity-60 text-sky-900"
              style={{ top: `${18 + bird * 15}%` }}
            >
              <svg className="w-12 h-6" viewBox="0 0 50 25" fill="currentColor">
                <path d="M0 12 Q 12 0 25 12 Q 38 0 50 12 Q 38 4 25 15 Q 12 4 0 12 Z" />
              </svg>
            </motion.div>
          ))}

          {/* Golden Sunbeam Pulse Highlight */}
          <motion.div
            animate={{ scale: [1, 1.15, 1], opacity: [0.35, 0.6, 0.35] }}
            transition={{ duration: 8, repeat: Infinity, ease: 'easeInOut' }}
            className="absolute -top-20 left-1/2 -translate-x-1/2 w-[34rem] h-[34rem] rounded-full bg-amber-100/40 blur-3xl pointer-events-none"
          />
        </div>
      )}
      ...
      {currentTheme === 'atom' && (
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[350px] border border-red-500/25 rounded-[100%] rotate-12">
            <motion.div
              animate={{ rotate: 360 }}
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] border border-blue-500/25 rounded-[100%] -rotate-25">
            <motion.div
              animate={{ rotate: -360 }}
          ...
          {/* Cosmic Center Elliptical Orbital Ring 3 (New Evolving Ring) */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] border border-cyan-400/20 rounded-full rotate-45">
            <motion.div
              animate={{ rotate: 360 }}
              transition={{ duration: 14, repeat: Infinity, ease: 'linear' }}
              className="w-full h-full relative"
            >
              <div className="absolute -top-2 left-1/2 w-3.5 h-3.5 rounded-full bg-cyan-300 shadow-[0_0_16px_#06B6D4]" />
            </motion.div>
          </div>
      ...
      {currentTheme === 'renaissance' && (
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-amber-950/40" />
          
          {/* Floating Royal Ambient Orbs */}
          <motion.div
            animate={{ scale: [1, 1.2, 1], opacity: [0.2, 0.45, 0.2] }}
            transition={{ duration: 10, repeat: Infinity, ease: 'easeInOut' }}
            className="absolute top-1/4 left-1/4 w-[450px] h-[450px] bg-amber-600/20 rounded-full blur-3xl"
          />
          ...
          {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
            <motion.div
              ...
              className="absolute w-2.5 h-2.5 rounded-full bg-amber-300 shadow-[0_0_14px_#D4AF37]"
              style={{
                bottom: '8%',
                left: `${6 + i * 12}%`,
              }}
      ...
      {/* ISLAMIC THEME: Pulsing 8-Point Star Geometric Mandala Aura & Floating Crescent Lights */}
      {currentTheme === 'islamic' && (
        <div className="absolute inset-0 flex items-center justify-center opacity-25 overflow-hidden">
          ...
          <motion.div
            ...
            className="w-[680px] h-[680px] rounded-full border-2 border-emerald-400 flex items-center justify-center relative"
          >
            <div className="absolute w-[540px] h-[540px] border-2 border-amber-400 rotate-45" />
            <div className="absolute w-[540px] h-[540px] border-2 border-amber-400 rotate-0" />
            <div className="absolute w-[400px] h-[400px] rounded-full border border-teal-300" />
            <div className="absolute w-[280px] h-[280px] border border-emerald-300 rotate-22.5" />
          </motion.div>

          {/* Floating Emerald Light Nodes */}
          {[1, 2, 3, 4].map((i) => (
            <motion.div
              key={i}
              animate={{
              ...
              className="absolute w-3 h-3 rounded-full bg-emerald-400 shadow-[0_0_15px_#10B981]"
              style={{
                top: `${20 + i * 18}%`,
                left: `${15 + i * 20}%`
              }}
      ...
      {currentTheme === 'cyberpunk' && (
        <div className="absolute inset-0 overflow-hidden bg-[#0D0221]">
          ...
          {[1, 2, 3, 4, 5, 6, 7].map((i) => (
            <motion.div
              key={i}
              animate={{ y: ['-20%', '120%'], opacity: [0, 0.95, 0] }}
              transition={{ duration: 2.8 + i * 0.7, repeat: Infinity, ease: 'linear', delay: i * 0.4 }}
              className="absolute w-[2px] h-36 bg-gradient-to-b from-transparent via-[#0FF4C6] to-[#FF0055] shadow-[0_0_12px_#0FF4C6]"
              style={{ left: `${8 + i * 14}%` }}
            />
          ))}
        </div>
      ...
      {currentTheme === 'nature' && (
        <div className="absolute inset-0 overflow-hidden bg-[#F1F8E9]">
          ...
          <motion.div
            ...
            className="absolute top-0 right-0 w-[550px] h-[550px] bg-amber-200/35 rounded-full blur-3xl"
          />
          ...
          {[1, 2, 3, 4, 5, 6, 7].map((i) => (
            <motion.div
              ...
              className="absolute text-emerald-600/45"
              style={{ left: `${4 + i * 14}%` }}
            >
      ...
      {currentTheme === 'monochrome' && (
        <div className="absolute inset-0 overflow-hidden opacity-25">
          ...
          <div className="absolute top-6 right-6 font-mono text-[10px] font-black tracking-widest text-black uppercase flex items-center gap-1.5">
          ...
          <motion.div
            ...
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-14 h-14 flex items-center justify-center border border-black/40 rounded-full"
          >
      ...
      {currentTheme === 'sunset' && (
        <div className="absolute inset-0 overflow-hidden bg-[#FFEBEE]">
          ...
          <motion.div
            ...
            transition={{ duration: 8, repeat: Infinity, ease: 'easeInOut' }}
            className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[750px] h-[380px] bg-gradient-to-t from-orange-500/35 via-rose-500/25 to-transparent rounded-t-full blur-2xl"
          />
          ...
          {[1, 2, 3, 4, 5, 6, 7].map((i) => (
            <motion.div
              ...
              className="absolute w-3 h-3 rounded-full bg-amber-400 shadow-[0_0_14px_#F59E0B]"
              style={{
                bottom: '12%',
                left: `${8 + i * 13}%`,
              }}
      ...
      {/* DARK THEME: Deep Space Starry Constellations & Shooting Stars */}
      {currentTheme === 'dark' && (
        <div className="absolute inset-0 overflow-hidden">
          {/* Twinkling Stars */}
        ...
        <div className="absolute inset-0 overflow-hidden bg-[#FAFBFD]">
          ...
          {[1, 2, 3, 4, 5].map((i) => (
            <motion.div
              ...
              className="absolute w-[2px] h-48 bg-gradient-to-b from-transparent via-indigo-400/35 to-transparent shadow-[0_0_10px_rgba(99,102,241,0.25)]"
              style={{ left: `${15 + i * 18}%` }}
            />
          ))}
